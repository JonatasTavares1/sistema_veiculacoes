...
from controllers.pi_controller import criar_pi, listar_pis, listar_pis_matriz_ativos, calcular_saldo_restante
...
class PIView(ctk.CTkFrame):
    def __init__(self, master=None):
        ...
        # Título e ComboBox PI Matriz
        ctk.CTkLabel(self.scrollable_frame, text="Selecione o PI Matriz que deseja vincular", font=ctk.CTkFont(weight="bold")).pack(pady=(4, 2))
    ...
    def cadastrar_pi(self):
        try:
            ...
            if not self.pi_matriz_var.get():
                if self.combo_pi_matriz.get() and self.combo_pi_matriz.get() != "Selecione o PI Matriz":
